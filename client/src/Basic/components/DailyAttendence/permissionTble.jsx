...
const Permissiontable = ({ reportView, permissionTableData, selectedShiftType, openModal, selectedBreakSummary, setSelectedBreakSummary,showModal,setShowModal,closeModal }) => {
    return (
        <>
            <div
