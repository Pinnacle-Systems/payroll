...
const LeaveRequestApproval = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            //     const allValidated = details?.every(
            //         v => v?.isApproved === true || v?.isApproved === false
            //     );

            //     return allValidated ? "Validated" : "Pending";
            // },
            accessor: (item) => {
                const details = item?.leaveDetails || [];
                ...
                if (
                    details.length > 0 &&
                    details.every(v => v?.isApproved === true || v?.isApproved === false)
                ) {
                    status = "Validated";
