    ...
    <>
      <div className="h-full  flex flex-col bg-gray-100">
        ...
        <div className="flex gap-x-3">
              ...
              <div className="grid grid-cols-7 gap-2 select-none">
                {allDays.map((date, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`h-9 text-sm flex items-center justify-center rounded-lg cursor-pointer
          ${isHighlighted ? "bg-violet-600 text-white" : "hover:bg-indigo-100"}`}
                      >
                        {day.date()}
                      </div>
          ...
          <div className=" max-h-[300px] p-2 mt-1 rounded-md shadow-sm transition-all duration-300 w-full mr-3 bg-white overflow-y-auto ">
            <h2>Leave Entry</h2>
