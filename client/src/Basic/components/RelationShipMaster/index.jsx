...
} from "../../../redux/services/RelationShipService";
...
export default function Form() {
  ...
  } = useGetRelationShipByIdQuery(id, { skip: !id });

  const [addData] = useAddRelationShipMutation();
  const [updateData] = useUpdateRelationShipMutation();
  const [removeData] = useDeleteRelationShipMutation();
  ...
  return (
    <div onKeyDown={handleKeyDown} className="p-1">
      <div className="w-full flex bg-white p-1 justify-between  items-center">
        <h1 className="text-2xl font-bold text-gray-800">RelationShip Master</h1>
