...
import { get as _get, getOne as _getOne, getSearch as _getSearch, create as _create, update as _update, remove as _remove ,getleavecount as _getleavecount} from '../services/leaveRequest.service.js';
...
async function getleavecount(req, res, next) {
    try {
        res.json(await _getleavecount(req.params.employeeId));
        console.log(res.statusCode);
    } catch (err) {
        console.error(`Error`, err.message);
    }
